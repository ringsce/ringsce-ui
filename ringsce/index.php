...
<!--<div id="app_basic" v-bind:title="timestamp" class="experiment-block">{{ message }}</div> -->
    ...
    <section class="py-5">
        <div class="container text-center py-5">
            <p class="mb-4" style="font-size: 1.6rem;">Used by us since 2021 and working on:</p>
        </div>
    </section>
    <section>
                    ...
                    <div class="col mb-5">
                        <div class="card shadow-sm">
                            <div class="card-body px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title">Web Design</h5>
                                <p class="text-muted card-text mb-4">We do Web Design.</p><button onclick = "window.location.href='web-design.php';" class="btn btn-primary shadow" type="button"> Learn more </button>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card shadow-sm">
                            <div class="card-body px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title">IoT</h5>
                                <p class="text-muted card-text mb-4">We do IoT Appliances.</p><button onclick = "window.location.href='iot.php';" class="btn btn-primary shadow" type="button">Learn more</button>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-4">
                        <div class="card shadow-sm">
                            <div class="card-body px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title">Desktop appliances</h5>
                                <p class="text-muted card-text mb-4">We do Desktop Appliances.</p><button onclick = "window.location.href='d-a.php ';" class="btn btn-primary shadow" type="button">Learn more</button>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-4">
                        <div class="card shadow-sm">
                            <div class="card-body px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title">Mobile Appliances</h5>
                                <p class="text-muted card-text mb-4">We do Mobile Appliances.</p><button onclick = "window.location.href='m-a.php';" class="btn btn-primary shadow" type="button">Learn more</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col mb-4">
                        <div class="card bg-primary-light">
                            <div class="card-body text-center px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title mb-3">Services you can find</h5><button onclick="window.location.href='services.php';" class="btn btn-primary btn-sm" type="button">Learn more</button>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-4">
                        <div class="card bg-secondary-light">
                            <div class="card-body text-center px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title mb-3">Screenshots</h5><button onclick = "window.location.href='screenshots.php';" class="btn btn-secondary btn-sm" type="button">Learn more</button>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-4">
                        <div class="card bg-info-light">
                            <div class="card-body text-center px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title mb-3">Libs</h5><button onclick="window.location.href='libs.php';" class="btn btn-info btn-sm" type="button">Learn more</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="d-flex flex-wrap flex-md-column justify-content-md-start align-items-md-start h-100">
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="px-2">
                                ...
                                <p class="text-muted mb-0">+351931308134</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="px-2">
                                ...
                                <p class="text-muted mb-0">sales@gleentech.com</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center p-3">
