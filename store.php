                        ...
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <p>Suscipit</p>
                                    <h4 class="display-4 fw-bold">$5</h4>
                                </div>
                            </div>
                            <div>
                            ...
                            </div><button class="btn btn-primary d-block w-100" type="button">Buy Legacy</button>
                        </div>
                    </div>
                </div>
                <div class="col mb-4">
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <p>Suscipit + donec</p>
                                    <h4 class="display-4 fw-bold text-white">$7</h4>
                                </div>
                            ...
                            </div><button class="btn btn-primary d-block w-100 bg-semi-white" type="button">Buy Pro</button>
                        </div>
                    </div>
                </div>
            </div>
