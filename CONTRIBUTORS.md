# Welcome to ringsce ui  docs contributing guide <!-- omit in toc -->
...
This library can be developed on Windows, however a few potential gotchas need to be kept in mind:
