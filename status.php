...
$services[] = array("port" => "8080",       "service" => "Web server HTTPS",                  "ip" => "") ;
$services[] = array("port" => "21",       "service" => "FTP",                     "ip" => "") ;
$services[] = array("port" => "22",       "service" => "SFTP",                     "ip" => "") ;
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 item text">
                        <h3>CAV Audiovisuais</h3>
                        <p>Praesent sed lobortis mi. Suspendisse vel placerat ligula. Vivamus ac sem lacus. Ut vehicula rhoncus elementum. Etiam quis tristique lectus. Aliquam in arcu eget velit pulvinar dictum vel in justo.</p>
                    </div>
                    <div class="col item social"><a href="#"><i class="icon ion-social-facebook"></i></a><a href="https://www.facebook.com/paulocavaq/"><i class="icon ion-social-twitter"></i></a><a href="#"><i class="icon ion-social-snapchat"></i></a><a href="#"><i class="icon ion-social-instagram"></i></a></div>
                </div>
                <p class="copyright">CAV Audiovisuais  © 2023</p>
            </div>
        </footer>
    </div>
