...
HX_LOCAL_STACK_FRAME(_hx_pos_b3b993f62d801895_247___init__,"::ApplicationMain_obj","__init__",0x253d991d,"::ApplicationMain_obj.__init__","ApplicationMain.hx",247,0x0780ded5)
...
void ApplicationMain_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_b3b993f62d801895_247___init__)
HXDLIN( 247)		 ::Dynamic init = ::hx::ClassOf< ::lime::app::Application >();
            	}
...
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Game",12,20,38,2f));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.sample.game",09,7b,b5,ce));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Game",12,20,38,2f))
