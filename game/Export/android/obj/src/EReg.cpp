...
HX_DEFINE_STACK_FRAME(_hx_pos_b2755210495ccca0_28_new,"EReg","new",0x8b859e81,"EReg.new","/opt/homebrew/lib/haxe/std/cpp/_std/EReg.hx",28,0x52e03918)
HX_LOCAL_STACK_FRAME(_hx_pos_b2755210495ccca0_36_match,"EReg","match",0x18fda1a6,"EReg.match","/opt/homebrew/lib/haxe/std/cpp/_std/EReg.hx",36,0x52e03918)
HX_LOCAL_STACK_FRAME(_hx_pos_b2755210495ccca0_45_matched,"EReg","matched",0x8ce62f85,"EReg.matched","/opt/homebrew/lib/haxe/std/cpp/_std/EReg.hx",45,0x52e03918)
HX_LOCAL_STACK_FRAME(_hx_pos_b2755210495ccca0_55_matchedRight,"EReg","matchedRight",0x6157ea17,"EReg.matchedRight","/opt/homebrew/lib/haxe/std/cpp/_std/EReg.hx",55,0x52e03918)
HX_LOCAL_STACK_FRAME(_hx_pos_b2755210495ccca0_62_matchedPos,"EReg","matchedPos",0x7007a70f,"EReg.matchedPos","/opt/homebrew/lib/haxe/std/cpp/_std/EReg.hx",62,0x52e03918)
HX_LOCAL_STACK_FRAME(_hx_pos_b2755210495ccca0_65_matchSub,"EReg","matchSub",0xbc75cb7a,"EReg.matchSub","/opt/homebrew/lib/haxe/std/cpp/_std/EReg.hx",65,0x52e03918)
HX_LOCAL_STACK_FRAME(_hx_pos_b2755210495ccca0_74_split,"EReg","split",0x9749433b,"EReg.split","/opt/homebrew/lib/haxe/std/cpp/_std/EReg.hx",74,0x52e03918)
HX_LOCAL_STACK_FRAME(_hx_pos_b2755210495ccca0_98_replace,"EReg","replace",0xae923ad5,"EReg.replace","/opt/homebrew/lib/haxe/std/cpp/_std/EReg.hx",98,0x52e03918)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b2755210495ccca0_149_map,"EReg","map",0x8b84d8bd,"EReg.map","/opt/homebrew/lib/haxe/std/cpp/_std/EReg.hx",149,0x52e03918)

void EReg_obj::__construct(::String r,::String opt){
            	HX_STACKFRAME(&_hx_pos_b2755210495ccca0_28_new)
...
bool EReg_obj::match(::String s){
            	HX_STACKFRAME(&_hx_pos_b2755210495ccca0_36_match)
...
::String EReg_obj::matched(int n){
            	HX_STACKFRAME(&_hx_pos_b2755210495ccca0_45_matched)
...
::String EReg_obj::matchedRight(){
            	HX_STACKFRAME(&_hx_pos_b2755210495ccca0_55_matchedRight)
...
HX_DEFINE_DYNAMIC_FUNC0(EReg_obj,matchedRight,return )
 ...
 ::Dynamic EReg_obj::matchedPos(){
            	HX_STACKFRAME(&_hx_pos_b2755210495ccca0_62_matchedPos)
...
bool EReg_obj::matchSub(::String s,int pos,::hx::Null< int >  __o_len){
            	...
            	HX_STACKFRAME(&_hx_pos_b2755210495ccca0_65_matchSub)
HXLINE(  66)		int p;
HXDLIN(  66)		if ((len < 0)) {
...
::Array< ::String > EReg_obj::split(::String s){
            	HX_STACKFRAME(&_hx_pos_b2755210495ccca0_74_split)
HXLINE(  75)		int pos = 0;
...
::String EReg_obj::replace(::String s,::String by){
            	HX_GC_STACKFRAME(&_hx_pos_b2755210495ccca0_98_replace)
...
::String EReg_obj::map(::String s, ::Dynamic f){
            	HX_GC_STACKFRAME(&_hx_pos_b2755210495ccca0_149_map)
