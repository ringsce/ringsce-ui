...
HXLINE(  14)		 ::openfl::display::Bitmap bitmap =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,::openfl::utils::Assets_obj::getBitmapData(HX_("assets/openfl.png",17,1a,ef,d0),null()),null(),null());
HXLINE(  15)		this->addChild(bitmap);
            	}
