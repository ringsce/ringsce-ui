...
HX_DEFINE_STACK_FRAME(_hx_pos_335a615362837636_29_new,"cpp.vm.WeakRef","new",0x9ce60541,"cpp.vm.WeakRef.new","/opt/homebrew/lib/haxe/std/cpp/vm/WeakRef.hx",29,0xa0b18ae7)
HX_LOCAL_STACK_FRAME(_hx_pos_335a615362837636_37_get,"cpp.vm.WeakRef","get",0x9ce0b577,"cpp.vm.WeakRef.get","/opt/homebrew/lib/haxe/std/cpp/vm/WeakRef.hx",37,0xa0b18ae7)
namespace cpp{
namespace vm{

void WeakRef_obj::__construct( ::Dynamic inObject,::hx::Null< bool >  __o_inHard){
            		bool inHard = __o_inHard.Default(false);
            	HX_STACKFRAME(&_hx_pos_335a615362837636_29_new)
...
bool WeakRef_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic WeakRef_obj::get(){
            	HX_STACKFRAME(&_hx_pos_335a615362837636_37_get)
