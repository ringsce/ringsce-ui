...
HX_LOCAL_STACK_FRAME(_hx_pos_d35781903287300e_34__loadPrime,"cpp.Prime","_loadPrime",0xdd360794,"cpp.Prime._loadPrime","/opt/homebrew/lib/haxe/std/cpp/Prime.hx",34,0xc97c36b3)
namespace cpp{
...
bool Prime_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Prime_obj::_loadPrime(::String lib,::String prim,::String signature,::hx::Null< bool >  __o_quietFail){
            	...
            	HX_STACKFRAME(&_hx_pos_d35781903287300e_34__loadPrime)
