...
HX_DEFINE_STACK_FRAME(_hx_pos_7060a18567ad6e07_94_new,"sys.io.Process","new",0x849b4c7a,"sys.io.Process.new","/opt/homebrew/lib/haxe/std/cpp/_std/sys/io/Process.hx",94,0xa37ff11f)
HX_LOCAL_STACK_FRAME(_hx_pos_7060a18567ad6e07_112_close,"sys.io.Process","close",0x0a954e52,"sys.io.Process.close","/opt/homebrew/lib/haxe/std/cpp/_std/sys/io/Process.hx",112,0xa37ff11f)
namespace sys{
namespace io{

void Process_obj::__construct(::String cmd,::Array< ::String > args, ::Dynamic detached){
            	HX_GC_STACKFRAME(&_hx_pos_7060a18567ad6e07_94_new)
...
void Process_obj::close(){
            	HX_STACKFRAME(&_hx_pos_7060a18567ad6e07_112_close)
