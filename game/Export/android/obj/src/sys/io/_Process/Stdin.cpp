...
HX_DEFINE_STACK_FRAME(_hx_pos_83476444d35e4903_31_new,"sys.io._Process.Stdin","new",0xd3131563,"sys.io._Process.Stdin.new","/opt/homebrew/lib/haxe/std/cpp/_std/sys/io/Process.hx",31,0xa37ff11f)
HX_LOCAL_STACK_FRAME(_hx_pos_83476444d35e4903_36_close,"sys.io._Process.Stdin","close",0xbd3fe37b,"sys.io._Process.Stdin.close","/opt/homebrew/lib/haxe/std/cpp/_std/sys/io/Process.hx",36,0xa37ff11f)
HX_LOCAL_STACK_FRAME(_hx_pos_83476444d35e4903_41_writeByte,"sys.io._Process.Stdin","writeByte",0xfb987cca,"sys.io._Process.Stdin.writeByte","/opt/homebrew/lib/haxe/std/cpp/_std/sys/io/Process.hx",41,0xa37ff11f)
HX_LOCAL_STACK_FRAME(_hx_pos_83476444d35e4903_47_writeBytes,"sys.io._Process.Stdin","writeBytes",0x29d4b469,"sys.io._Process.Stdin.writeBytes","/opt/homebrew/lib/haxe/std/cpp/_std/sys/io/Process.hx",47,0xa37ff11f)
namespace sys{
namespace io{
namespace _Process{

void Stdin_obj::__construct( ::Dynamic p){
            	HX_STACKFRAME(&_hx_pos_83476444d35e4903_31_new)
HXLINE(  32)		this->p = p;
...
void Stdin_obj::close(){
            	HX_STACKFRAME(&_hx_pos_83476444d35e4903_36_close)
...
void Stdin_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_83476444d35e4903_41_writeByte)
...
int Stdin_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_83476444d35e4903_47_writeBytes)
HXDLIN(  47)		try {
