...
HX_DEFINE_STACK_FRAME(_hx_pos_094d3e3199b96bd8_61_new,"sys.io._Process.Stdout","new",0xc765a8f4,"sys.io._Process.Stdout.new","/opt/homebrew/lib/haxe/std/cpp/_std/sys/io/Process.hx",61,0xa37ff11f)
HX_LOCAL_STACK_FRAME(_hx_pos_094d3e3199b96bd8_67_readByte,"sys.io._Process.Stdout","readByte",0xa72b886a,"sys.io._Process.Stdout.readByte","/opt/homebrew/lib/haxe/std/cpp/_std/sys/io/Process.hx",67,0xa37ff11f)
HX_LOCAL_STACK_FRAME(_hx_pos_094d3e3199b96bd8_73_readBytes,"sys.io._Process.Stdout","readBytes",0x9eebd4c9,"sys.io._Process.Stdout.readBytes","/opt/homebrew/lib/haxe/std/cpp/_std/sys/io/Process.hx",73,0xa37ff11f)
namespace sys{
namespace io{
namespace _Process{

void Stdout_obj::__construct( ::Dynamic p,bool out){
            	HX_STACKFRAME(&_hx_pos_094d3e3199b96bd8_61_new)
HXLINE(  62)		this->p = p;
...
int Stdout_obj::readByte(){
            	HX_STACKFRAME(&_hx_pos_094d3e3199b96bd8_67_readByte)
...
int Stdout_obj::readBytes( ::haxe::io::Bytes str,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_094d3e3199b96bd8_73_readBytes)
