...
HX_DEFINE_STACK_FRAME(_hx_pos_eef86d0ad0db16ee_33_new,"sys.io.FileInput","new",0x565591b9,"sys.io.FileInput.new","/opt/homebrew/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",33,0x68952500)
HX_LOCAL_STACK_FRAME(_hx_pos_eef86d0ad0db16ee_37_readByte,"sys.io.FileInput","readByte",0x25e0b585,"sys.io.FileInput.readByte","/opt/homebrew/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",37,0x68952500)
HX_LOCAL_STACK_FRAME(_hx_pos_eef86d0ad0db16ee_48_readBytes,"sys.io.FileInput","readBytes",0xfebe1f4e,"sys.io.FileInput.readBytes","/opt/homebrew/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",48,0x68952500)
HX_LOCAL_STACK_FRAME(_hx_pos_eef86d0ad0db16ee_58_close,"sys.io.FileInput","close",0x735aa151,"sys.io.FileInput.close","/opt/homebrew/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",58,0x68952500)
namespace sys{
namespace io{

void FileInput_obj::__construct( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_eef86d0ad0db16ee_33_new)
...
int FileInput_obj::readByte(){
            	HX_GC_STACKFRAME(&_hx_pos_eef86d0ad0db16ee_37_readByte)
HXDLIN(  37)		try {
...
int FileInput_obj::readBytes( ::haxe::io::Bytes s,int p,int l){
            	HX_GC_STACKFRAME(&_hx_pos_eef86d0ad0db16ee_48_readBytes)
HXDLIN(  48)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void FileInput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_eef86d0ad0db16ee_58_close)
