...
HX_DEFINE_STACK_FRAME(_hx_pos_8bff9ab36e6cc9e7_30_new,"sys.thread.Lock","new",0x586e3f40,"sys.thread.Lock.new","/opt/homebrew/lib/haxe/std/cpp/_std/sys/thread/Lock.hx",30,0x7e20a7a7)
HX_LOCAL_STACK_FRAME(_hx_pos_8bff9ab36e6cc9e7_34_wait,"sys.thread.Lock","wait",0x0df8ef95,"sys.thread.Lock.wait","/opt/homebrew/lib/haxe/std/cpp/_std/sys/thread/Lock.hx",34,0x7e20a7a7)
namespace sys{
namespace thread{

void Lock_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_8bff9ab36e6cc9e7_30_new)
...
bool Lock_obj::wait( ::Dynamic __o_timeout){
            	...
            	HX_STACKFRAME(&_hx_pos_8bff9ab36e6cc9e7_34_wait)
