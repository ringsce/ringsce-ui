...
HX_DEFINE_STACK_FRAME(_hx_pos_4b642efc181d4eb5_7_new,"sys.thread.NoEventLoopException","new",0x6e47ae47,"sys.thread.NoEventLoopException.new","/opt/homebrew/lib/haxe/std/sys/thread/NoEventLoopException.hx",7,0x0e2ac2f1)
namespace sys{
namespace thread{
...
void NoEventLoopException_obj::__construct(::String __o_msg, ::haxe::Exception previous){
            	...
            	HX_STACKFRAME(&_hx_pos_4b642efc181d4eb5_7_new)
