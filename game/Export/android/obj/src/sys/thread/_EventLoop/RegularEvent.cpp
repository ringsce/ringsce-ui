...
HX_DEFINE_STACK_FRAME(_hx_pos_f0db1ff40e8d225f_278_new,"sys.thread._EventLoop.RegularEvent","new",0x9d3b475c,"sys.thread._EventLoop.RegularEvent.new","/opt/homebrew/lib/haxe/std/sys/thread/EventLoop.hx",278,0x83aee35b)
namespace sys{
namespace thread{
namespace _EventLoop{

void RegularEvent_obj::__construct( ::Dynamic run,Float nextRunTime,Float interval){
            	HX_STACKFRAME(&_hx_pos_f0db1ff40e8d225f_278_new)
