...
HX_LOCAL_STACK_FRAME(_hx_pos_aa4533205a1f5b69_54_get_events,"sys.thread._Thread.Thread_Impl_","get_events",0x2940127e,"sys.thread._Thread.Thread_Impl_.get_events","/opt/homebrew/lib/haxe/std/cpp/_std/sys/thread/Thread.hx",54,0x30b20328)
HX_LOCAL_STACK_FRAME(_hx_pos_aa4533205a1f5b69_62_processEvents,"sys.thread._Thread.Thread_Impl_","processEvents",0xf30238cc,"sys.thread._Thread.Thread_Impl_.processEvents","/opt/homebrew/lib/haxe/std/cpp/_std/sys/thread/Thread.hx",62,0x30b20328)
namespace sys{
namespace thread{
namespace _Thread{
...
bool Thread_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::sys::thread::EventLoop Thread_Impl__obj::get_events( ::sys::thread::_Thread::HaxeThread this1){
            	HX_GC_STACKFRAME(&_hx_pos_aa4533205a1f5b69_54_get_events)
...
void Thread_Impl__obj::processEvents(){
            	HX_STACKFRAME(&_hx_pos_aa4533205a1f5b69_62_processEvents)
