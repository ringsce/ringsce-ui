...
HX_DEFINE_STACK_FRAME(_hx_pos_5ed92ae5dc6e41ad_30_new,"sys.thread.Mutex","new",0x0051f1ae,"sys.thread.Mutex.new","/opt/homebrew/lib/haxe/std/cpp/_std/sys/thread/Mutex.hx",30,0x998ca62b)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed92ae5dc6e41ad_34_acquire,"sys.thread.Mutex","acquire",0xae482c24,"sys.thread.Mutex.acquire","/opt/homebrew/lib/haxe/std/cpp/_std/sys/thread/Mutex.hx",34,0x998ca62b)
HX_LOCAL_STACK_FRAME(_hx_pos_5ed92ae5dc6e41ad_42_release,"sys.thread.Mutex","release",0x52516615,"sys.thread.Mutex.release","/opt/homebrew/lib/haxe/std/cpp/_std/sys/thread/Mutex.hx",42,0x998ca62b)
namespace sys{
namespace thread{

void Mutex_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_5ed92ae5dc6e41ad_30_new)
...
void Mutex_obj::acquire(){
            	HX_STACKFRAME(&_hx_pos_5ed92ae5dc6e41ad_34_acquire)
...
void Mutex_obj::release(){
            	HX_STACKFRAME(&_hx_pos_5ed92ae5dc6e41ad_42_release)
