...
HX_LOCAL_STACK_FRAME(_hx_pos_070fd3f43dcec3a4_31_exists,"sys.FileSystem","exists",0xf55bed9e,"sys.FileSystem.exists","/opt/homebrew/lib/haxe/std/cpp/_std/sys/FileSystem.hx",31,0x40a8c77a)
HX_LOCAL_STACK_FRAME(_hx_pos_070fd3f43dcec3a4_38_stat,"sys.FileSystem","stat",0xa630df16,"sys.FileSystem.stat","/opt/homebrew/lib/haxe/std/cpp/_std/sys/FileSystem.hx",38,0x40a8c77a)
HX_LOCAL_STACK_FRAME(_hx_pos_070fd3f43dcec3a4_75_isDirectory,"sys.FileSystem","isDirectory",0x6c577a21,"sys.FileSystem.isDirectory","/opt/homebrew/lib/haxe/std/cpp/_std/sys/FileSystem.hx",75,0x40a8c77a)
HX_LOCAL_STACK_FRAME(_hx_pos_070fd3f43dcec3a4_78_createDirectory,"sys.FileSystem","createDirectory",0x63bad3cf,"sys.FileSystem.createDirectory","/opt/homebrew/lib/haxe/std/cpp/_std/sys/FileSystem.hx",78,0x40a8c77a)
HX_LOCAL_STACK_FRAME(_hx_pos_070fd3f43dcec3a4_93_deleteFile,"sys.FileSystem","deleteFile",0x4bd48509,"sys.FileSystem.deleteFile","/opt/homebrew/lib/haxe/std/cpp/_std/sys/FileSystem.hx",93,0x40a8c77a)
HX_LOCAL_STACK_FRAME(_hx_pos_070fd3f43dcec3a4_97_deleteDirectory,"sys.FileSystem","deleteDirectory",0x052a5cc0,"sys.FileSystem.deleteDirectory","/opt/homebrew/lib/haxe/std/cpp/_std/sys/FileSystem.hx",97,0x40a8c77a)
HX_LOCAL_STACK_FRAME(_hx_pos_070fd3f43dcec3a4_101_readDirectory,"sys.FileSystem","readDirectory",0x0619f8b5,"sys.FileSystem.readDirectory","/opt/homebrew/lib/haxe/std/cpp/_std/sys/FileSystem.hx",101,0x40a8c77a)
namespace sys{
...
bool FileSystem_obj::exists(::String path){
            	HX_STACKFRAME(&_hx_pos_070fd3f43dcec3a4_31_exists)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FileSystem_obj,exists,return )
 ...
 ::Dynamic FileSystem_obj::stat(::String path){
            	HX_STACKFRAME(&_hx_pos_070fd3f43dcec3a4_38_stat)
HXLINE(  39)		::String s;
HXDLIN(  39)		bool s1;
...
bool FileSystem_obj::isDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_070fd3f43dcec3a4_75_isDirectory)
...
void FileSystem_obj::createDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_070fd3f43dcec3a4_78_createDirectory)
...
void FileSystem_obj::deleteFile(::String path){
            	HX_STACKFRAME(&_hx_pos_070fd3f43dcec3a4_93_deleteFile)
...
void FileSystem_obj::deleteDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_070fd3f43dcec3a4_97_deleteDirectory)
...
::Array< ::String > FileSystem_obj::readDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_070fd3f43dcec3a4_101_readDirectory)
