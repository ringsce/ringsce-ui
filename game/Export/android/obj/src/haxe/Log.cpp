...
HX_LOCAL_STACK_FRAME(_hx_pos_e790db379e38313c_30___default_trace,"haxe.Log","__default_trace",0xe2f5e5d5,"haxe.Log.__default_trace","/opt/homebrew/lib/haxe/std/cpp/_std/haxe/Log.hx",30,0x110e9c6c)
namespace haxe{
...
void _hx_run( ::Dynamic v, ::Dynamic infos){
            	HX_STACKFRAME(&_hx_pos_e790db379e38313c_30___default_trace)
