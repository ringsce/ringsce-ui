...
HX_DEFINE_STACK_FRAME(_hx_pos_662cd66d8e8f81d1_512_new,"haxe._Unserializer.DefaultResolver","new",0xe2809ead,"haxe._Unserializer.DefaultResolver.new","/opt/homebrew/lib/haxe/std/haxe/Unserializer.hx",512,0x4b232a32)
HX_LOCAL_STACK_FRAME(_hx_pos_662cd66d8e8f81d1_515_resolveClass,"haxe._Unserializer.DefaultResolver","resolveClass",0xbc0d3dbf,"haxe._Unserializer.DefaultResolver.resolveClass","/opt/homebrew/lib/haxe/std/haxe/Unserializer.hx",515,0x4b232a32)
HX_LOCAL_STACK_FRAME(_hx_pos_662cd66d8e8f81d1_518_resolveEnum,"haxe._Unserializer.DefaultResolver","resolveEnum",0x8198f35a,"haxe._Unserializer.DefaultResolver.resolveEnum","/opt/homebrew/lib/haxe/std/haxe/Unserializer.hx",518,0x4b232a32)
namespace haxe{
namespace _Unserializer{

void DefaultResolver_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_662cd66d8e8f81d1_512_new)
            	}
...
::hx::Class DefaultResolver_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_662cd66d8e8f81d1_515_resolveClass)
...
::hx::Class DefaultResolver_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_662cd66d8e8f81d1_518_resolveEnum)
