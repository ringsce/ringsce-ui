...
HX_LOCAL_STACK_FRAME(_hx_pos_c07bf2f8db4b01e2_43_sort,"haxe.ds.ArraySort","sort",0xa0749d6c,"haxe.ds.ArraySort.sort","/opt/homebrew/lib/haxe/std/haxe/ds/ArraySort.hx",43,0x3c283446)
HX_LOCAL_STACK_FRAME(_hx_pos_c07bf2f8db4b01e2_46_rec,"haxe.ds.ArraySort","rec",0xd9af5f02,"haxe.ds.ArraySort.rec","/opt/homebrew/lib/haxe/std/haxe/ds/ArraySort.hx",46,0x3c283446)
HX_LOCAL_STACK_FRAME(_hx_pos_c07bf2f8db4b01e2_68_doMerge,"haxe.ds.ArraySort","doMerge",0x66c5c9df,"haxe.ds.ArraySort.doMerge","/opt/homebrew/lib/haxe/std/haxe/ds/ArraySort.hx",68,0x3c283446)
HX_LOCAL_STACK_FRAME(_hx_pos_c07bf2f8db4b01e2_94_rotate,"haxe.ds.ArraySort","rotate",0xb7d0dbe9,"haxe.ds.ArraySort.rotate","/opt/homebrew/lib/haxe/std/haxe/ds/ArraySort.hx",94,0x3c283446)
HX_LOCAL_STACK_FRAME(_hx_pos_c07bf2f8db4b01e2_115_gcd,"haxe.ds.ArraySort","gcd",0xd9a7047a,"haxe.ds.ArraySort.gcd","/opt/homebrew/lib/haxe/std/haxe/ds/ArraySort.hx",115,0x3c283446)
HX_LOCAL_STACK_FRAME(_hx_pos_c07bf2f8db4b01e2_124_upper,"haxe.ds.ArraySort","upper",0xed09ef94,"haxe.ds.ArraySort.upper","/opt/homebrew/lib/haxe/std/haxe/ds/ArraySort.hx",124,0x3c283446)
HX_LOCAL_STACK_FRAME(_hx_pos_c07bf2f8db4b01e2_139_lower,"haxe.ds.ArraySort","lower",0xbdcad033,"haxe.ds.ArraySort.lower","/opt/homebrew/lib/haxe/std/haxe/ds/ArraySort.hx",139,0x3c283446)
HX_LOCAL_STACK_FRAME(_hx_pos_c07bf2f8db4b01e2_153_swap,"haxe.ds.ArraySort","swap",0xa07aa0a1,"haxe.ds.ArraySort.swap","/opt/homebrew/lib/haxe/std/haxe/ds/ArraySort.hx",153,0x3c283446)
namespace haxe{
namespace ds{
...
void ArraySort_obj::sort(::cpp::VirtualArray a, ::Dynamic cmp){
            	HX_STACKFRAME(&_hx_pos_c07bf2f8db4b01e2_43_sort)
...
void ArraySort_obj::rec(::cpp::VirtualArray a, ::Dynamic cmp,int from,int to){
            	HX_STACKFRAME(&_hx_pos_c07bf2f8db4b01e2_46_rec)
...
void ArraySort_obj::doMerge(::cpp::VirtualArray a, ::Dynamic cmp,int from,int pivot,int to,int len1,int len2){
            	HX_STACKFRAME(&_hx_pos_c07bf2f8db4b01e2_68_doMerge)
...
void ArraySort_obj::rotate(::cpp::VirtualArray a, ::Dynamic cmp,int from,int mid,int to){
            	HX_STACKFRAME(&_hx_pos_c07bf2f8db4b01e2_94_rotate)
...
int ArraySort_obj::gcd(int m,int n){
            	HX_STACKFRAME(&_hx_pos_c07bf2f8db4b01e2_115_gcd)
...
int ArraySort_obj::upper(::cpp::VirtualArray a, ::Dynamic cmp,int from,int to,int val){
            	HX_STACKFRAME(&_hx_pos_c07bf2f8db4b01e2_124_upper)
...
int ArraySort_obj::lower(::cpp::VirtualArray a, ::Dynamic cmp,int from,int to,int val){
            	HX_STACKFRAME(&_hx_pos_c07bf2f8db4b01e2_139_lower)
...
void ArraySort_obj::swap(::cpp::VirtualArray a,int i,int j){
            	HX_STACKFRAME(&_hx_pos_c07bf2f8db4b01e2_153_swap)
