...
HX_DEFINE_STACK_FRAME(_hx_pos_f9d27b3cccc92d72_252_new,"haxe.ds.TreeNode","new",0x88d32f89,"haxe.ds.TreeNode.new","/opt/homebrew/lib/haxe/std/haxe/ds/BalancedTree.hx",252,0xb30a13d9)
namespace haxe{
namespace ds{
...
void TreeNode_obj::__construct( ::haxe::ds::TreeNode l, ::Dynamic k, ::Dynamic v, ::haxe::ds::TreeNode r,::hx::Null< int >  __o_h){
            	...
            	HX_STACKFRAME(&_hx_pos_f9d27b3cccc92d72_252_new)
