...
HX_DEFINE_STACK_FRAME(_hx_pos_31d31441684b7cba_35_new,"haxe.iterators.MapKeyValueIterator","new",0x902a97fd,"haxe.iterators.MapKeyValueIterator.new","/opt/homebrew/lib/haxe/std/haxe/iterators/MapKeyValueIterator.hx",35,0x856b9dcd)
HX_LOCAL_STACK_FRAME(_hx_pos_31d31441684b7cba_44_hasNext,"haxe.iterators.MapKeyValueIterator","hasNext",0x6e75ff8a,"haxe.iterators.MapKeyValueIterator.hasNext","/opt/homebrew/lib/haxe/std/haxe/iterators/MapKeyValueIterator.hx",44,0x856b9dcd)
HX_LOCAL_STACK_FRAME(_hx_pos_31d31441684b7cba_50_next,"haxe.iterators.MapKeyValueIterator","next",0x951a66b6,"haxe.iterators.MapKeyValueIterator.next","/opt/homebrew/lib/haxe/std/haxe/iterators/MapKeyValueIterator.hx",50,0x856b9dcd)
namespace haxe{
namespace iterators{

void MapKeyValueIterator_obj::__construct(::Dynamic map){
            	HX_STACKFRAME(&_hx_pos_31d31441684b7cba_35_new)
...
bool MapKeyValueIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_31d31441684b7cba_44_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(MapKeyValueIterator_obj,hasNext,return )
 ...
 ::Dynamic MapKeyValueIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_31d31441684b7cba_50_next)
