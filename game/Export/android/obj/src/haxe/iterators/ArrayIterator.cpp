...
HX_DEFINE_STACK_FRAME(_hx_pos_4ed7f4b21e769cef_28_new,"haxe.iterators.ArrayIterator","new",0x70a754c8,"haxe.iterators.ArrayIterator.new","/opt/homebrew/lib/haxe/std/haxe/iterators/ArrayIterator.hx",28,0x0b92dbe2)
HX_LOCAL_STACK_FRAME(_hx_pos_4ed7f4b21e769cef_45_hasNext,"haxe.iterators.ArrayIterator","hasNext",0x74587dd5,"haxe.iterators.ArrayIterator.hasNext","/opt/homebrew/lib/haxe/std/haxe/iterators/ArrayIterator.hx",45,0x0b92dbe2)
HX_LOCAL_STACK_FRAME(_hx_pos_4ed7f4b21e769cef_53_next,"haxe.iterators.ArrayIterator","next",0x21c2db8b,"haxe.iterators.ArrayIterator.next","/opt/homebrew/lib/haxe/std/haxe/iterators/ArrayIterator.hx",53,0x0b92dbe2)
namespace haxe{
namespace iterators{

void ArrayIterator_obj::__construct(::cpp::VirtualArray array){
            	HX_STACKFRAME(&_hx_pos_4ed7f4b21e769cef_28_new)
...
bool ArrayIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_4ed7f4b21e769cef_45_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(ArrayIterator_obj,hasNext,return )
 ...
 ::Dynamic ArrayIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_4ed7f4b21e769cef_53_next)
