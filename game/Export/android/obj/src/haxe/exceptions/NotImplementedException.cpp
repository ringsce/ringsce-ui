...
HX_DEFINE_STACK_FRAME(_hx_pos_c0e4f4e6b6d34484_8_new,"haxe.exceptions.NotImplementedException","new",0xcfd1d5d0,"haxe.exceptions.NotImplementedException.new","/opt/homebrew/lib/haxe/std/haxe/exceptions/NotImplementedException.hx",8,0xda490b48)
namespace haxe{
...
void NotImplementedException_obj::__construct(::String __o_message, ::haxe::Exception previous, ::Dynamic pos){
            	...
            	HX_STACKFRAME(&_hx_pos_c0e4f4e6b6d34484_8_new)
