...
HX_DEFINE_STACK_FRAME(_hx_pos_d1e724f54f805732_12_new,"haxe.exceptions.PosException","new",0x9ed038cf,"haxe.exceptions.PosException.new","/opt/homebrew/lib/haxe/std/haxe/exceptions/PosException.hx",12,0x7028ecd9)
HX_LOCAL_STACK_FRAME(_hx_pos_d1e724f54f805732_25_toString,"haxe.exceptions.PosException","toString",0x179675dd,"haxe.exceptions.PosException.toString","/opt/homebrew/lib/haxe/std/haxe/exceptions/PosException.hx",25,0x7028ecd9)
namespace haxe{
namespace exceptions{

void PosException_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic pos){
            	HX_STACKFRAME(&_hx_pos_d1e724f54f805732_12_new)
...
::String PosException_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_d1e724f54f805732_25_toString)
