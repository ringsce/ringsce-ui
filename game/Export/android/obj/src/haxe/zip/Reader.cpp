...
HX_DEFINE_STACK_FRAME(_hx_pos_c913ef92080c87c6_33_new,"haxe.zip.Reader","new",0xf101338a,"haxe.zip.Reader.new","/opt/homebrew/lib/haxe/std/haxe/zip/Reader.hx",33,0xb870406c)
HX_LOCAL_STACK_FRAME(_hx_pos_c913ef92080c87c6_36_readZipDate,"haxe.zip.Reader","readZipDate",0xa6a02623,"haxe.zip.Reader.readZipDate","/opt/homebrew/lib/haxe/std/haxe/zip/Reader.hx",36,0xb870406c)
HX_LOCAL_STACK_FRAME(_hx_pos_c913ef92080c87c6_48_readExtraFields,"haxe.zip.Reader","readExtraFields",0x48ea639d,"haxe.zip.Reader.readExtraFields","/opt/homebrew/lib/haxe/std/haxe/zip/Reader.hx",48,0xb870406c)
HX_LOCAL_STACK_FRAME(_hx_pos_c913ef92080c87c6_78_readEntryHeader,"haxe.zip.Reader","readEntryHeader",0x28765213,"haxe.zip.Reader.readEntryHeader","/opt/homebrew/lib/haxe/std/haxe/zip/Reader.hx",78,0xb870406c)
HX_LOCAL_STACK_FRAME(_hx_pos_c913ef92080c87c6_121_read,"haxe.zip.Reader","read",0xf2b0acec,"haxe.zip.Reader.read","/opt/homebrew/lib/haxe/std/haxe/zip/Reader.hx",121,0xb870406c)
HX_LOCAL_STACK_FRAME(_hx_pos_c913ef92080c87c6_194_readZip,"haxe.zip.Reader","readZip",0x2845d555,"haxe.zip.Reader.readZip","/opt/homebrew/lib/haxe/std/haxe/zip/Reader.hx",194,0xb870406c)
namespace haxe{
namespace zip{

void Reader_obj::__construct( ::haxe::io::Input i){
            	HX_STACKFRAME(&_hx_pos_c913ef92080c87c6_33_new)
HXDLIN(  33)		this->i = i;
            	}
...
bool Reader_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Date Reader_obj::readZipDate(){
            	HX_GC_STACKFRAME(&_hx_pos_c913ef92080c87c6_36_readZipDate)
...
HX_DEFINE_DYNAMIC_FUNC0(Reader_obj,readZipDate,return )
 ...
 ::haxe::ds::List Reader_obj::readExtraFields(int length){
            	HX_GC_STACKFRAME(&_hx_pos_c913ef92080c87c6_48_readExtraFields)
...
HX_DEFINE_DYNAMIC_FUNC1(Reader_obj,readExtraFields,return )
 ...
 ::Dynamic Reader_obj::readEntryHeader(){
            	HX_STACKFRAME(&_hx_pos_c913ef92080c87c6_78_readEntryHeader)
...
HX_DEFINE_DYNAMIC_FUNC0(Reader_obj,readEntryHeader,return )
 ...
 ::haxe::ds::List Reader_obj::read(){
            	HX_GC_STACKFRAME(&_hx_pos_c913ef92080c87c6_121_read)
...
HX_DEFINE_DYNAMIC_FUNC0(Reader_obj,read,return )
 ...
 ::haxe::ds::List Reader_obj::readZip( ::haxe::io::Input i){
            	HX_GC_STACKFRAME(&_hx_pos_c913ef92080c87c6_194_readZip)
