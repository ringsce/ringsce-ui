...
HX_DEFINE_STACK_FRAME(_hx_pos_24ac5cf6f4457bfa_32_new,"haxe.zip.HuffTools","new",0x5263948b,"haxe.zip.HuffTools.new","/opt/homebrew/lib/haxe/std/haxe/zip/Huffman.hx",32,0x5a49c580)
HX_LOCAL_STACK_FRAME(_hx_pos_24ac5cf6f4457bfa_35_treeDepth,"haxe.zip.HuffTools","treeDepth",0x748ac930,"haxe.zip.HuffTools.treeDepth","/opt/homebrew/lib/haxe/std/haxe/zip/Huffman.hx",35,0x5a49c580)
HX_LOCAL_STACK_FRAME(_hx_pos_24ac5cf6f4457bfa_45_treeCompress,"haxe.zip.HuffTools","treeCompress",0x66340995,"haxe.zip.HuffTools.treeCompress","/opt/homebrew/lib/haxe/std/haxe/zip/Huffman.hx",45,0x5a49c580)
HX_LOCAL_STACK_FRAME(_hx_pos_24ac5cf6f4457bfa_63_treeWalk,"haxe.zip.HuffTools","treeWalk",0x2e5c697c,"haxe.zip.HuffTools.treeWalk","/opt/homebrew/lib/haxe/std/haxe/zip/Huffman.hx",63,0x5a49c580)
HX_LOCAL_STACK_FRAME(_hx_pos_24ac5cf6f4457bfa_75_treeMake,"haxe.zip.HuffTools","treeMake",0x27c04661,"haxe.zip.HuffTools.treeMake","/opt/homebrew/lib/haxe/std/haxe/zip/Huffman.hx",75,0x5a49c580)
HX_LOCAL_STACK_FRAME(_hx_pos_24ac5cf6f4457bfa_86_make,"haxe.zip.HuffTools","make",0xc4121b63,"haxe.zip.HuffTools.make","/opt/homebrew/lib/haxe/std/haxe/zip/Huffman.hx",86,0x5a49c580)
namespace haxe{
namespace zip{

void HuffTools_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_24ac5cf6f4457bfa_32_new)
            	}
...
int HuffTools_obj::treeDepth( ::haxe::zip::Huffman t){
            	HX_STACKFRAME(&_hx_pos_24ac5cf6f4457bfa_35_treeDepth)
...
HX_DEFINE_DYNAMIC_FUNC1(HuffTools_obj,treeDepth,return )
 ...
 ::haxe::zip::Huffman HuffTools_obj::treeCompress( ::haxe::zip::Huffman t){
            	HX_STACKFRAME(&_hx_pos_24ac5cf6f4457bfa_45_treeCompress)
...
void HuffTools_obj::treeWalk(::Array< ::Dynamic> table,int p,int cd,int d, ::haxe::zip::Huffman t){
            	HX_STACKFRAME(&_hx_pos_24ac5cf6f4457bfa_63_treeWalk)
...
HX_DEFINE_DYNAMIC_FUNC5(HuffTools_obj,treeWalk,(void))
 ...
 ::haxe::zip::Huffman HuffTools_obj::treeMake( ::haxe::ds::IntMap bits,int maxbits,int v,int len){
            	HX_STACKFRAME(&_hx_pos_24ac5cf6f4457bfa_75_treeMake)
...
HX_DEFINE_DYNAMIC_FUNC4(HuffTools_obj,treeMake,return )
 ...
 ::haxe::zip::Huffman HuffTools_obj::make(::Array< int > lengths,int pos,int nlengths,int maxbits){
            	HX_GC_STACKFRAME(&_hx_pos_24ac5cf6f4457bfa_86_make)
