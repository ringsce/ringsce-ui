...
HX_DEFINE_STACK_FRAME(_hx_pos_10015a6c40cc25bd_37_new,"haxe.zip._InflateImpl.Window","new",0x88adb9f3,"haxe.zip._InflateImpl.Window.new","/opt/homebrew/lib/haxe/std/haxe/zip/InflateImpl.hx",37,0xe6801566)
HX_LOCAL_STACK_FRAME(_hx_pos_10015a6c40cc25bd_44_slide,"haxe.zip._InflateImpl.Window","slide",0x409d7984,"haxe.zip._InflateImpl.Window.slide","/opt/homebrew/lib/haxe/std/haxe/zip/InflateImpl.hx",44,0xe6801566)
HX_LOCAL_STACK_FRAME(_hx_pos_10015a6c40cc25bd_53_addBytes,"haxe.zip._InflateImpl.Window","addBytes",0xb984b017,"haxe.zip._InflateImpl.Window.addBytes","/opt/homebrew/lib/haxe/std/haxe/zip/InflateImpl.hx",53,0xe6801566)
HX_LOCAL_STACK_FRAME(_hx_pos_10015a6c40cc25bd_60_addByte,"haxe.zip._InflateImpl.Window","addByte",0xa74a10dc,"haxe.zip._InflateImpl.Window.addByte","/opt/homebrew/lib/haxe/std/haxe/zip/InflateImpl.hx",60,0xe6801566)
HX_LOCAL_STACK_FRAME(_hx_pos_10015a6c40cc25bd_68_getLastChar,"haxe.zip._InflateImpl.Window","getLastChar",0xdd866f95,"haxe.zip._InflateImpl.Window.getLastChar","/opt/homebrew/lib/haxe/std/haxe/zip/InflateImpl.hx",68,0xe6801566)
HX_LOCAL_STACK_FRAME(_hx_pos_10015a6c40cc25bd_72_available,"haxe.zip._InflateImpl.Window","available",0x3285339c,"haxe.zip._InflateImpl.Window.available","/opt/homebrew/lib/haxe/std/haxe/zip/InflateImpl.hx",72,0xe6801566)
HX_LOCAL_STACK_FRAME(_hx_pos_10015a6c40cc25bd_75_checksum,"haxe.zip._InflateImpl.Window","checksum",0x2f923f50,"haxe.zip._InflateImpl.Window.checksum","/opt/homebrew/lib/haxe/std/haxe/zip/InflateImpl.hx",75,0xe6801566)
namespace haxe{
namespace zip{
namespace _InflateImpl{

void Window_obj::__construct(bool hasCrc){
            	HX_GC_STACKFRAME(&_hx_pos_10015a6c40cc25bd_37_new)
...
void Window_obj::slide(){
            	HX_STACKFRAME(&_hx_pos_10015a6c40cc25bd_44_slide)
...
void Window_obj::addBytes( ::haxe::io::Bytes b,int p,int len){
            	HX_STACKFRAME(&_hx_pos_10015a6c40cc25bd_53_addBytes)
...
void Window_obj::addByte(int c){
            	HX_STACKFRAME(&_hx_pos_10015a6c40cc25bd_60_addByte)
...
int Window_obj::getLastChar(){
            	HX_STACKFRAME(&_hx_pos_10015a6c40cc25bd_68_getLastChar)
...
int Window_obj::available(){
            	HX_STACKFRAME(&_hx_pos_10015a6c40cc25bd_72_available)
...
HX_DEFINE_DYNAMIC_FUNC0(Window_obj,available,return )
 ...
 ::haxe::crypto::Adler32 Window_obj::checksum(){
            	HX_STACKFRAME(&_hx_pos_10015a6c40cc25bd_75_checksum)
