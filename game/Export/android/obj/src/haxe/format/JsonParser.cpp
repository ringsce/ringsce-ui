...
HX_DEFINE_STACK_FRAME(_hx_pos_48b26c51cc4373cd_51_new,"haxe.format.JsonParser","new",0xa017eec8,"haxe.format.JsonParser.new","/opt/homebrew/lib/haxe/std/haxe/format/JsonParser.hx",51,0x69b02280)
HX_LOCAL_STACK_FRAME(_hx_pos_48b26c51cc4373cd_56_doParse,"haxe.format.JsonParser","doParse",0xa959e310,"haxe.format.JsonParser.doParse","/opt/homebrew/lib/haxe/std/haxe/format/JsonParser.hx",56,0x69b02280)
HX_LOCAL_STACK_FRAME(_hx_pos_48b26c51cc4373cd_71_parseRec,"haxe.format.JsonParser","parseRec",0xda258b75,"haxe.format.JsonParser.parseRec","/opt/homebrew/lib/haxe/std/haxe/format/JsonParser.hx",71,0x69b02280)
HX_LOCAL_STACK_FRAME(_hx_pos_48b26c51cc4373cd_152_parseString,"haxe.format.JsonParser","parseString",0x8c919bcc,"haxe.format.JsonParser.parseString","/opt/homebrew/lib/haxe/std/haxe/format/JsonParser.hx",152,0x69b02280)
HX_LOCAL_STACK_FRAME(_hx_pos_48b26c51cc4373cd_316_invalidChar,"haxe.format.JsonParser","invalidChar",0xa9f373d5,"haxe.format.JsonParser.invalidChar","/opt/homebrew/lib/haxe/std/haxe/format/JsonParser.hx",316,0x69b02280)
HX_LOCAL_STACK_FRAME(_hx_pos_48b26c51cc4373cd_322_invalidNumber,"haxe.format.JsonParser","invalidNumber",0x8e9d1988,"haxe.format.JsonParser.invalidNumber","/opt/homebrew/lib/haxe/std/haxe/format/JsonParser.hx",322,0x69b02280)
namespace haxe{
namespace format{

void JsonParser_obj::__construct(::String str){
            	HX_STACKFRAME(&_hx_pos_48b26c51cc4373cd_51_new)
...
bool JsonParser_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic JsonParser_obj::doParse(){
            	HX_STACKFRAME(&_hx_pos_48b26c51cc4373cd_56_doParse)
...
HX_DEFINE_DYNAMIC_FUNC0(JsonParser_obj,doParse,return )
 ...
 ::Dynamic JsonParser_obj::parseRec(){
            	HX_STACKFRAME(&_hx_pos_48b26c51cc4373cd_71_parseRec)
...
::String JsonParser_obj::parseString(){
            	HX_GC_STACKFRAME(&_hx_pos_48b26c51cc4373cd_152_parseString)
...
void JsonParser_obj::invalidChar(){
            	HX_STACKFRAME(&_hx_pos_48b26c51cc4373cd_316_invalidChar)
HXLINE( 317)		this->pos--;
...
void JsonParser_obj::invalidNumber(int start){
            	HX_STACKFRAME(&_hx_pos_48b26c51cc4373cd_322_invalidNumber)
