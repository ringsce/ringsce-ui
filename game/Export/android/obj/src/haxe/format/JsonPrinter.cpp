...
HX_DEFINE_STACK_FRAME(_hx_pos_d75c8405591c82a3_56_new,"haxe.format.JsonPrinter","new",0xeb68de75,"haxe.format.JsonPrinter.new","/opt/homebrew/lib/haxe/std/haxe/format/JsonPrinter.hx",56,0xefb002c3)
HX_LOCAL_STACK_FRAME(_hx_pos_d75c8405591c82a3_81_write,"haxe.format.JsonPrinter","write",0x755dea34,"haxe.format.JsonPrinter.write","/opt/homebrew/lib/haxe/std/haxe/format/JsonPrinter.hx",81,0xefb002c3)
...
HX_LOCAL_STACK_FRAME(_hx_pos_d75c8405591c82a3_158_classString,"haxe.format.JsonPrinter","classString",0x9219ba3e,"haxe.format.JsonPrinter.classString","/opt/homebrew/lib/haxe/std/haxe/format/JsonPrinter.hx",158,0xefb002c3)
HX_LOCAL_STACK_FRAME(_hx_pos_d75c8405591c82a3_165_fieldsString,"haxe.format.JsonPrinter","fieldsString",0x974bd375,"haxe.format.JsonPrinter.fieldsString","/opt/homebrew/lib/haxe/std/haxe/format/JsonPrinter.hx",165,0xefb002c3)
HX_LOCAL_STACK_FRAME(_hx_pos_d75c8405591c82a3_196_quote,"haxe.format.JsonPrinter","quote",0x02f6a091,"haxe.format.JsonPrinter.quote","/opt/homebrew/lib/haxe/std/haxe/format/JsonPrinter.hx",196,0xefb002c3)
...
HX_LOCAL_STACK_FRAME(_hx_pos_d75c8405591c82a3_44_print,"haxe.format.JsonPrinter","print",0x6d8fd582,"haxe.format.JsonPrinter.print","/opt/homebrew/lib/haxe/std/haxe/format/JsonPrinter.hx",44,0xefb002c3)
namespace haxe{
namespace format{

void JsonPrinter_obj::__construct( ::Dynamic replacer,::String space){
            	HX_GC_STACKFRAME(&_hx_pos_d75c8405591c82a3_56_new)
...
void JsonPrinter_obj::write( ::Dynamic k, ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_d75c8405591c82a3_81_write)
...
void JsonPrinter_obj::classString( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_d75c8405591c82a3_158_classString)
...
void JsonPrinter_obj::fieldsString( ::Dynamic v,::Array< ::String > fields){
            	HX_STACKFRAME(&_hx_pos_d75c8405591c82a3_165_fieldsString)
HXLINE( 166)		{
...
void JsonPrinter_obj::quote(::String s){
            	HX_STACKFRAME(&_hx_pos_d75c8405591c82a3_196_quote)
HXLINE( 203)		{
...
::String JsonPrinter_obj::print( ::Dynamic o, ::Dynamic replacer,::String space){
            	HX_GC_STACKFRAME(&_hx_pos_d75c8405591c82a3_44_print)
