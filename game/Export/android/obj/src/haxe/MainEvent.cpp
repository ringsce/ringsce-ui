...
HX_DEFINE_STACK_FRAME(_hx_pos_45aa0b0c18712850_9_new,"haxe.MainEvent","new",0x1c640c2b,"haxe.MainEvent.new","/opt/homebrew/lib/haxe/std/haxe/MainLoop.hx",9,0x432df0e0)
namespace haxe{

void MainEvent_obj::__construct( ::Dynamic f,int p){
            	HX_STACKFRAME(&_hx_pos_45aa0b0c18712850_9_new)
