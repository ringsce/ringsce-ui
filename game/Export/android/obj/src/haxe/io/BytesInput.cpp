...
HX_DEFINE_STACK_FRAME(_hx_pos_21911aaf1e11a6ef_39_new,"haxe.io.BytesInput","new",0x7fa18571,"haxe.io.BytesInput.new","/opt/homebrew/lib/haxe/std/haxe/io/BytesInput.hx",39,0xa97d6377)
HX_LOCAL_STACK_FRAME(_hx_pos_21911aaf1e11a6ef_96_readByte,"haxe.io.BytesInput","readByte",0xb70e46cd,"haxe.io.BytesInput.readByte","/opt/homebrew/lib/haxe/std/haxe/io/BytesInput.hx",96,0xa97d6377)
HX_LOCAL_STACK_FRAME(_hx_pos_21911aaf1e11a6ef_119_readBytes,"haxe.io.BytesInput","readBytes",0x756fad06,"haxe.io.BytesInput.readBytes","/opt/homebrew/lib/haxe/std/haxe/io/BytesInput.hx",119,0xa97d6377)
namespace haxe{
namespace io{

void BytesInput_obj::__construct( ::haxe::io::Bytes b, ::Dynamic pos, ::Dynamic len){
            	HX_STACKFRAME(&_hx_pos_21911aaf1e11a6ef_39_new)
...
int BytesInput_obj::readByte(){
            	HX_GC_STACKFRAME(&_hx_pos_21911aaf1e11a6ef_96_readByte)
...
int BytesInput_obj::readBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_21911aaf1e11a6ef_119_readBytes)
