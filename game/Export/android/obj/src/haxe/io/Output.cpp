...
HX_LOCAL_STACK_FRAME(_hx_pos_10f2a46803650432_47_writeByte,"haxe.io.Output","writeByte",0xb4fe513a,"haxe.io.Output.writeByte","/opt/homebrew/lib/haxe/std/haxe/io/Output.hx",47,0x14788955)
HX_LOCAL_STACK_FRAME(_hx_pos_10f2a46803650432_57_writeBytes,"haxe.io.Output","writeBytes",0xa988c1f9,"haxe.io.Output.writeBytes","/opt/homebrew/lib/haxe/std/haxe/io/Output.hx",57,0x14788955)
HX_LOCAL_STACK_FRAME(_hx_pos_10f2a46803650432_92_close,"haxe.io.Output","close",0xe726bfeb,"haxe.io.Output.close","/opt/homebrew/lib/haxe/std/haxe/io/Output.hx",92,0x14788955)
HX_LOCAL_STACK_FRAME(_hx_pos_10f2a46803650432_254_writeInput,"haxe.io.Output","writeInput",0xaa0e7d98,"haxe.io.Output.writeInput","/opt/homebrew/lib/haxe/std/haxe/io/Output.hx",254,0x14788955)
namespace haxe{
namespace io{
...
void Output_obj::writeByte(int c){
            	HX_GC_STACKFRAME(&_hx_pos_10f2a46803650432_47_writeByte)
...
int Output_obj::writeBytes( ::haxe::io::Bytes s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_10f2a46803650432_57_writeBytes)
...
void Output_obj::close(){
            	HX_STACKFRAME(&_hx_pos_10f2a46803650432_92_close)
            	}
...
void Output_obj::writeInput( ::haxe::io::Input i, ::Dynamic bufsize){
            	HX_STACKFRAME(&_hx_pos_10f2a46803650432_254_writeInput)
