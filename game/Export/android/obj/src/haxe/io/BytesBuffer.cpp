...
HX_DEFINE_STACK_FRAME(_hx_pos_e284c9d04c3303e0_52_new,"haxe.io.BytesBuffer","new",0x022790dd,"haxe.io.BytesBuffer.new","/opt/homebrew/lib/haxe/std/haxe/io/BytesBuffer.hx",52,0x5a9395db)
HX_LOCAL_STACK_FRAME(_hx_pos_e284c9d04c3303e0_202_getBytes,"haxe.io.BytesBuffer","getBytes",0x1e9f7258,"haxe.io.BytesBuffer.getBytes","/opt/homebrew/lib/haxe/std/haxe/io/BytesBuffer.hx",202,0x5a9395db)
namespace haxe{
namespace io{

void BytesBuffer_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e284c9d04c3303e0_52_new)
...
bool BytesBuffer_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes BytesBuffer_obj::getBytes(){
            	HX_GC_STACKFRAME(&_hx_pos_e284c9d04c3303e0_202_getBytes)
