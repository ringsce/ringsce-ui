...
HX_DEFINE_STACK_FRAME(_hx_pos_93a0c1aba85dfd29_23_new,"haxe.ValueException","new",0xb19045f8,"haxe.ValueException.new","/opt/homebrew/lib/haxe/std/haxe/ValueException.hx",23,0xfea19d5f)
namespace haxe{

void ValueException_obj::__construct( ::Dynamic value, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_93a0c1aba85dfd29_23_new)
