...
HX_DEFINE_STACK_FRAME(_hx_pos_f707a01425baf2ae_5_new,"haxe.Exception","new",0xa32fba59,"haxe.Exception.new","/opt/homebrew/lib/haxe/std/cpp/_std/haxe/Exception.hx",5,0x4c4ce301)
HX_LOCAL_STACK_FRAME(_hx_pos_f707a01425baf2ae_56_toString,"haxe.Exception","toString",0x11a32013,"haxe.Exception.toString","/opt/homebrew/lib/haxe/std/cpp/_std/haxe/Exception.hx",56,0x4c4ce301)
HX_LOCAL_STACK_FRAME(_hx_pos_f707a01425baf2ae_76_get_message,"haxe.Exception","get_message",0x7b47a0d7,"haxe.Exception.get_message","/opt/homebrew/lib/haxe/std/cpp/_std/haxe/Exception.hx",76,0x4c4ce301)
HX_LOCAL_STACK_FRAME(_hx_pos_f707a01425baf2ae_19_caught,"haxe.Exception","caught",0xbc294f23,"haxe.Exception.caught","/opt/homebrew/lib/haxe/std/cpp/_std/haxe/Exception.hx",19,0x4c4ce301)
namespace haxe{

void Exception_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_f707a01425baf2ae_5_new)
...
::String Exception_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_f707a01425baf2ae_56_toString)
...
::String Exception_obj::get_message(){
            	HX_STACKFRAME(&_hx_pos_f707a01425baf2ae_76_get_message)
...
HX_DEFINE_DYNAMIC_FUNC0(Exception_obj,get_message,return )
 ...
 ::haxe::Exception Exception_obj::caught( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_f707a01425baf2ae_19_caught)
