...
HX_DEFINE_STACK_FRAME(_hx_pos_914eb60a675e9a70_35_new,"StringBuf","new",0xaaa8f4b4,"StringBuf.new","/opt/homebrew/lib/haxe/std/cpp/_std/StringBuf.hx",35,0x7e216f93)
HX_LOCAL_STACK_FRAME(_hx_pos_914eb60a675e9a70_37_charBufAsString,"StringBuf","charBufAsString",0x54d38cd4,"StringBuf.charBufAsString","/opt/homebrew/lib/haxe/std/cpp/_std/StringBuf.hx",37,0x7e216f93)
HX_LOCAL_STACK_FRAME(_hx_pos_914eb60a675e9a70_43_flush,"StringBuf","flush",0xc7c14418,"StringBuf.flush","/opt/homebrew/lib/haxe/std/cpp/_std/StringBuf.hx",43,0x7e216f93)
HX_LOCAL_STACK_FRAME(_hx_pos_914eb60a675e9a70_51_get_length,"StringBuf","get_length",0xe673d2db,"StringBuf.get_length","/opt/homebrew/lib/haxe/std/cpp/_std/StringBuf.hx",51,0x7e216f93)
HX_LOCAL_STACK_FRAME(_hx_pos_914eb60a675e9a70_92_toString,"StringBuf","toString",0x68f17bd8,"StringBuf.toString","/opt/homebrew/lib/haxe/std/cpp/_std/StringBuf.hx",92,0x7e216f93)

void StringBuf_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_914eb60a675e9a70_35_new)
            	}
...
::String StringBuf_obj::charBufAsString(){
            	HX_STACKFRAME(&_hx_pos_914eb60a675e9a70_37_charBufAsString)
...
void StringBuf_obj::flush(){
            	HX_STACKFRAME(&_hx_pos_914eb60a675e9a70_43_flush)
...
int StringBuf_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_914eb60a675e9a70_51_get_length)
HXLINE(  52)		int len = 0;
...
::String StringBuf_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_914eb60a675e9a70_92_toString)
