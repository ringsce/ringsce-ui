...
HXLINE( 408)			{
HXLINE( 408)				::Dynamic this1 = ::openfl::text::_internal::TextEngine_obj::_hx___defaultFonts;
HXDLIN( 408)				( ( ::haxe::ds::StringMap)(this1) )->set(HX_("_sans",32,a0,5e,ff), ::openfl::text::_internal::_TextEngine::DefaultFontSet_obj::__alloc( HX_CTX ,::openfl::text::_internal::TextEngine_obj::findFont((systemFontDirectory + HX_("/DroidSans.ttf",f8,c6,8e,4f))),null(),null(),null()));
            			}
HXLINE( 409)			{
HXLINE( 409)				::Dynamic this2 = ::openfl::text::_internal::TextEngine_obj::_hx___defaultFonts;
HXDLIN( 409)				( ( ::haxe::ds::StringMap)(this2) )->set(HX_("_serif",be,66,15,76), ::openfl::text::_internal::_TextEngine::DefaultFontSet_obj::__alloc( HX_CTX ,( ( ::openfl::text::Font)(processFontList(::Array_obj< ::String >::__new(2)->init(0,(systemFontDirectory + HX_("/DroidSerif-Regular.ttf",57,b0,ef,46)))->init(1,(systemFontDirectory + HX_("/NotoSerif-Regular.ttf",59,73,f1,28))))) ),null(),null(),null()));
            			}
HXLINE( 413)			{
HXLINE( 413)				::Dynamic this3 = ::openfl::text::_internal::TextEngine_obj::_hx___defaultFonts;
HXDLIN( 413)				( ( ::haxe::ds::StringMap)(this3) )->set(HX_("_typewriter",0c,5e,52,94), ::openfl::text::_internal::_TextEngine::DefaultFontSet_obj::__alloc( HX_CTX ,::openfl::text::_internal::TextEngine_obj::findFont((systemFontDirectory + HX_("/DroidSansMono.ttf",bb,6c,31,55))),null(),null(),null()));
            			}
            		}
