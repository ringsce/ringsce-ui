...
HXLINE( 198)			 ::Dynamic getDisplayDPI = ::lime::_hx_system::JNI_obj::createStaticMethod(HX_("org/haxe/lime/GameActivity",1d,61,c7,a4),HX_("getDisplayXDPI",31,6c,16,bf),HX_("()D",23,7e,1e,00),null(),null());
HXLINE( 199)			display->dpi = ( (Float)(::Math_obj::round(( (Float)(getDisplayDPI()) ))) );
...
HXLINE( 311)			 ::Dynamic openFile = ::lime::_hx_system::JNI_obj::createStaticMethod(HX_("org/haxe/lime/GameActivity",1d,61,c7,a4),HX_("openFile",66,ab,f7,e4),HX_("(Ljava/lang/String;)V",7f,b4,bc,c7),null(),null());
HXLINE( 312)			openFile(path);
            		}
            	}
...
HXLINE( 330)			 ::Dynamic openURL = ::lime::_hx_system::JNI_obj::createStaticMethod(HX_("org/haxe/lime/GameActivity",1d,61,c7,a4),HX_("openURL",c5,bd,35,40),HX_("(Ljava/lang/String;Ljava/lang/String;)V",49,45,e8,06),null(),null());
HXLINE( 331)			openURL(url,target);
            		}
            	}
...
HXLINE( 398)			::String seperator = HX_("/",2f,00,00,00);
...
HXLINE( 610)			::String manufacturer = ( (::String)(::lime::_hx_system::JNI_obj::createStaticField(HX_("android/os/Build",c3,62,50,61),HX_("MANUFACTURER",51,72,a3,b2),HX_("Ljava/lang/String;",ca,05,90,bc))->get()) );
HXLINE( 611)			::String model = ( (::String)(::lime::_hx_system::JNI_obj::createStaticField(HX_("android/os/Build",c3,62,50,61),HX_("MODEL",89,5b,46,8a),HX_("Ljava/lang/String;",ca,05,90,bc))->get()) );
HXLINE( 612)			bool _hx_tmp;
HXDLIN( 612)			if (::hx::IsNotNull( manufacturer )) {
HXLINE( 612)				_hx_tmp = ::hx::IsNotNull( model );
            			}
            			else {
HXLINE( 612)				_hx_tmp = false;
            			}
HXDLIN( 612)			if (_hx_tmp) {
HXLINE( 614)				::String _hx_tmp1 = model.toLowerCase();
HXDLIN( 614)				if (::StringTools_obj::startsWith(_hx_tmp1,manufacturer.toLowerCase())) {
HXLINE( 616)					model = ::StringTools_obj::trim(model.substr(manufacturer.length,null()));
HXLINE( 617)					while(::StringTools_obj::startsWith(model,HX_("-",2d,00,00,00))){
HXLINE( 619)						model = ::StringTools_obj::trim(model.substr(1,null()));
            					}
            				}
HXLINE( 622)				::lime::_hx_system::System_obj::_hx___deviceModel = model;
            			}
            		}
...
HXLINE( 645)			::String vendor = ( (::String)(::lime::_hx_system::JNI_obj::createStaticField(HX_("android/os/Build",c3,62,50,61),HX_("MANUFACTURER",51,72,a3,b2),HX_("Ljava/lang/String;",ca,05,90,bc))->get()) );
HXLINE( 646)			if (::hx::IsNotNull( vendor )) {
HXLINE( 648)				::String _hx_tmp = vendor.charAt(0).toUpperCase();
HXDLIN( 648)				::lime::_hx_system::System_obj::_hx___deviceVendor = (_hx_tmp + vendor.substr(1,null()));
            			}
            		}
...
HXLINE( 734)			::String name = ::lime::_hx_system::System_obj::get_platformName();
HXLINE( 735)			::String version = ::lime::_hx_system::System_obj::get_platformVersion();
HXLINE( 736)			bool _hx_tmp;
HXDLIN( 736)			if (::hx::IsNotNull( name )) {
HXLINE( 736)				_hx_tmp = ::hx::IsNotNull( version );
            			}
            			else {
HXLINE( 736)				_hx_tmp = false;
            			}
HXDLIN( 736)			if (_hx_tmp) {
HXLINE( 736)				::lime::_hx_system::System_obj::_hx___platformLabel = ((name + HX_(" ",20,00,00,00)) + version);
            			}
            			else {
HXLINE( 737)				if (::hx::IsNotNull( name )) {
HXLINE( 737)					::lime::_hx_system::System_obj::_hx___platformLabel = name;
            				}
            			}
            		}
...
HXLINE( 757)			::lime::_hx_system::System_obj::_hx___platformName = HX_("Android",0f,c3,f5,69);
            		}
...
HXLINE( 793)			::String release = ( (::String)(::lime::_hx_system::JNI_obj::createStaticField(HX_("android/os/Build$VERSION",17,25,43,51),HX_("RELEASE",a7,59,c1,d8),HX_("Ljava/lang/String;",ca,05,90,bc))->get()) );
HXLINE( 794)			::String api = ( (::String)(::lime::_hx_system::JNI_obj::createStaticField(HX_("android/os/Build$VERSION",17,25,43,51),HX_("SDK_INT",6a,79,ca,19),HX_("I",49,00,00,00))->get()) );
HXLINE( 795)			bool _hx_tmp;
HXDLIN( 795)			if (::hx::IsNotNull( release )) {
HXLINE( 795)				_hx_tmp = ::hx::IsNotNull( api );
            			}
            			else {
HXLINE( 795)				_hx_tmp = false;
            			}
HXDLIN( 795)			if (_hx_tmp) {
HXLINE( 795)				::lime::_hx_system::System_obj::_hx___platformVersion = (((release + HX_(" (API ",6e,92,a6,fe)) + api) + HX_(")",29,00,00,00));
            			}
            		}
