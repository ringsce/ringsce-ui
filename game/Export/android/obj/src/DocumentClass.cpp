...
HX_DEFINE_STACK_FRAME(_hx_pos_9453f8fd92a21d0a_306_new,"DocumentClass","new",0x4aeb0a6f,"DocumentClass.new","ApplicationMain.hx",306,0x0780ded5)

void DocumentClass_obj::__construct( ::openfl::display::DisplayObjectContainer current){
            	HX_GC_STACKFRAME(&_hx_pos_9453f8fd92a21d0a_306_new)
HXLINE( 307)		current->addChild(::hx::ObjectPtr<OBJ_>(this));
HXLINE( 308)		super::__construct();
HXLINE( 309)		this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("addedToStage",63,22,55,0c),false,false));
            	}
